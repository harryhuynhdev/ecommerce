            ...
            <div class="row">
                <div class="col-md-6 col-xl-3">
                    <div class="card-box tilebox-one">
                        ...
                        <h6 class="text-muted text-uppercase mt-0">Số đơn hàng hôm nay</h6>
                        <h3 class="my-3" data-plugin="counterup"><?php foreach ($price_today as $key => $value) {
                ...
                <div class="col-md-6 col-xl-3">
                    <div class="card-box tilebox-one">
                        ...
                        <h6 class="text-muted text-uppercase mt-0">Số lượng sản phẩm</h6>
                        <h3 class="my-3" data-plugin="counterup"><?php foreach ($quantity_pro as $key => $value) {
                                                                        echo "$value";
                                                                    } ?></h3>
                ...
                <div class="col-md-6 col-xl-3">
                    <div class="card-box tilebox-one">
                        ...
                        <h6 class="text-muted text-uppercase mt-0">Tổng số đơn hàng</h6>
                        <h3 class="my-3"><span data-plugin="counterup"><?php foreach ($card as $key => $value) {
                                                                            echo "$value";
                                                                        } ?></span></h3>
                ...
                <div class="col-md-6 col-xl-3">
                    <div class="card-box tilebox-one">
                        ...
                        <h6 class="text-muted text-uppercase mt-0">Tổng doanh thu(VNĐ)</h6>
                        <h3 class="my-3"><span data-plugin="counterup"><?php foreach ($price as $key => $value) {
                    ...
                    <div class="row text-center">
                        <div class='col-12'>
                            <div class="card">
                                ...
                                <canvas id="value-data1" style="height:200px; width:520px"></canvas>
                            </div>
                        </div>
                        <div class='col-12'>
                            <div class="card">
                                <h4>Doanh thu theo tháng</h4>
                                <canvas id="value-data" style="height:200px; width:520px"></canvas>
                            </div>
                        </div>
                    </div>
...
<script>
    $(document).ready(function() {
        $.ajax({
            ...
            success: function(data) {
                ...
                var price = [];
                for (var i in data) {
                    date_time.push(data[i].thang);
                    price.push(data[i].rate);
                }
    ...
    $(document).ready(function() {
        $.ajax({
            url: "model/date_data.php",
            method: "GET",
            dataType: "JSON",
            success: function(data_date) {
                var data_day = [];
                var price = [];
                for (var i in data_date) {
                    data_day.push(data_date[i].data_day);
                    price.push(data_date[i].price);
                }
